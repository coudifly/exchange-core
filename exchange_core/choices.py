...
BR_BANKS_CHOICES = [
    ...
    ('14', '14 - Natixis Brasil S.A. Banco Múltiplo'),
    ('18', '18 - Banco Tricury S.A.'),
    ('19', '19 - Banco Azteca do Brasil S.A.'),
    ('21', '21 - BANESTES S.A. Banco do Estado do Espírito Santo'),
    ('24', '24 - Banco BANDEPE S.A.'),
    ...
    ('39', '39 - Banco do Estado do Piauí S.A. - BEP'),
    ...
    ('65', '65 - Banco AndBank (Brasil) S.A.'),
    ('66', '66 - Banco Morgan Stanley S.A.'),
    ...
    ('75', '75 - Banco ABN AMRO S.A.'),
    ('76', '76 - Banco KDB S.A.'),
    ('77', '77 - Banco Intermedium S.A.'),
    ('78', '78 - BES Investimento do Brasil S.A.-Banco de Investimento'),
    ('79', '79 - Banco Original do Agronegócio S.A.'),
    ('81', '81 - BBN Banco Brasileiro de Negócios S.A.'),
    ('82', '82 - Banco Topázio S.A.'),
    ('83', '83 - Banco da China Brasil S.A.'),
    ('85', '85 - Cooperativa Central de Crédito Urbano-CECRED'),
    ('86', '86 - OBOE Crédito Financiamento e Investimento S.A.'),
    ('87', '87 - Cooperativa Unicred Central Santa Catarina'),
    ('88', '88 - Banco Randon S.A.'),
    ('89', '89 - Cooperativa de Crédito Rural da Região de Mogiana'),
    ('90', '90 - Cooperativa Central de Economia e Crédito Mutuo das Unicreds'),
    ('91', '91 - Unicred Central do Rio Grande do Sul'),
    ('92', '92 - Brickell S.A. Crédito, financiamento e Investimento'),
    ('94', '94 - Banco Petra S.A.'),
    ('95', '95 - Banco Confidence de Câmbio S.A.'),
    ('96', '96 - Banco BM&FBOVESPA de Serviços de Liquidação e Custódia S.A'),
    ('97', '97 - Cooperativa Central de Crédito Noroeste Brasileiro Ltda.'),
    ('98', '98 - CREDIALIANÇA COOPERATIVA DE CRÉDITO RURAL'),
    ('99', '99 - Cooperativa Central de Economia e Credito Mutuo das Unicreds'),
    ('104', '104 - Caixa Econômica Federal'),
    ('107', '107 - Banco BBM S.A.'),
    ('114', '114 - Central das Coop. de Economia e Crédito Mutuo do Est. do ES'),
    ('119', '119 - Banco Western Union do Brasil S.A.'),
    ('122', '122 - Banco BERJ S.A.'),
    ('125', '125 - Brasil Plural S.A. - Banco Múltiplo'),
    ('136', '136 - CONFEDERACAO NACIONAL DAS COOPERATIVAS CENTRAIS UNICREDS'),
    ('168', '168 - HSBC Finance (Brasil) S.A. - Banco Múltiplo'),
    ...
    ('233', '233 - Banco Cifra S.A.'),
    ('237', '237 - Banco Bradesco S.A.'),
    ('241', '241 - Banco Clássico S.A.'),
    ...
    ('370', '370 - Banco Mizuho do Brasil S.A.'),
    ...
    ('741', '741 - Banco Ribeirão Preto S.A.'),
    ...
    ('751', '751 - ScotiaBank Brasil S.A. Banco Múltiplo'),
    ('752', '752 - Banco BNP Paribas Brasil S.A.'),
    ('753', '753 - NBC Bank Brasil S.A. - Banco Múltiplo'),
    ('755', '755 - Bank of America Merrill Lynch Banco Múltiplo S.A.'),
