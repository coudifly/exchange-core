# Generated by Django 2.0.1 on 2018-03-28 14:36
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('exchange_core', '0034_auto_20180325_1451'),
    ]
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='bankwithdraw',
            options={'verbose_name': 'Bank withdraw', 'verbose_name_plural': 'Bank withdrawals'},
        ),
        migrations.AlterModelOptions(
            name='companies',
        ...
        migrations.AlterModelOptions(
            name='cryptowithdraw',
            options={'verbose_name': 'Crypto withdraw', 'verbose_name_plural': 'Crypto withdrawals'},
        ),
        ...
        migrations.AlterField(
            ...
            name='account',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bank_accounts', to='exchange_core.Accounts', verbose_name='Account'),
        ),
        migrations.AlterField(
            model_name='bankwithdraw',
            name='account',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bank_withdraw', to='exchange_core.Accounts', verbose_name='Account'),
        ),
        migrations.AlterField(
            model_name='bankwithdraw',
            name='account_number',
        ...
        migrations.AlterField(
            model_name='bankwithdraw',
            name='account_type',
            field=models.CharField(choices=[('corrente', 'Corrente'), ('poupanca', 'Poupança')], max_length=20, verbose_name='Account type'),
        ),
        migrations.AlterField(
            model_name='bankwithdraw',
            name='agency',
            field=models.CharField(max_length=10, verbose_name='Agency'),
        ),
        migrations.AlterField(
            model_name='bankwithdraw',
            name='agency_digit',
        ...
        migrations.AlterField(
            model_name='bankwithdraw',
            name='fee',
            field=models.DecimalField(decimal_places=8, default=Decimal('0.00'), max_digits=20, verbose_name='Fee'),
        ),
        migrations.AlterField(
            model_name='bankwithdraw',
            name='reserved',
        ...
        migrations.AlterField(
            ...
            name='account',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='crypto_withdraw', to='exchange_core.Accounts', verbose_name='Account'),
        ),
        migrations.AlterField(
            model_name='cryptowithdraw',
            name='address',
        ...
        migrations.AlterField(
            ...
            name='file',
            field=models.ImageField(upload_to=exchange_core.models.get_file_path, verbose_name='File'),
        ),
        migrations.AlterField(
            model_name='documents',
            name='status',
        ...
        migrations.AlterField(
            model_name='documents',
            name='type',
            field=models.CharField(choices=[('id_front', 'id_front'), ('id_back', 'id_back'), ('selfie', 'selfie'), ('contract', 'contract'), ('residence', 'residence')], max_length=20, verbose_name='Type'),
        ),
        migrations.AlterField(
            model_name='documents',
            name='user',
        ...
        migrations.AlterField(
            model_name='statement',
            name='fk',
            field=models.UUIDField(blank=True, editable=False, null=True, verbose_name='Foreign key'),
        ),
        migrations.AlterField(
            model_name='statement',
            name='tx_id',
