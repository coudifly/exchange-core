...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            name='accounts',
            options={'ordering': ['currency__name'], 'verbose_name': 'Currency account',
        ...
        migrations.AlterModelOptions(
            name='bankwithdraw',
            options={'verbose_name': 'Bank withdraw',
        ...
        migrations.AlterModelOptions(
            name='cryptowithdraw',
            options={'verbose_name': 'Crypto withdraw',
        ...
        migrations.AlterField(
            ...
            field=models.DecimalField(decimal_places=8, default=Decimal(
                '0.00'), max_digits=20, verbose_name='Deposit'),
        ),
        migrations.AlterField(
            model_name='accounts',
            name='deposit_address',
            field=models.CharField(
                blank=True, max_length=255, null=True, verbose_name='Deposit address'),
        ),
        migrations.AlterField(
            model_name='accounts',
            name='reserved',
            field=models.DecimalField(decimal_places=8, default=Decimal(
                '0.00'), max_digits=20, verbose_name='Reserved'),
        ),
        migrations.AlterField(
            model_name='addresses',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                    related_name='addresses', to=settings.AUTH_USER_MODEL, verbose_name='User'),
        ),
        migrations.AlterField(
            model_name='bankaccounts',
            name='account',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                    related_name='bank_accounts', to='exchange_core.Accounts', verbose_name='Account'),
        ),
        migrations.AlterField(
            model_name='bankwithdraw',
            name='account',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                    related_name='bank_withdraw', to='exchange_core.Accounts', verbose_name='Account'),
        ),
        migrations.AlterField(
            model_name='bankwithdraw',
            name='account_number',
            field=models.CharField(
                max_length=20, verbose_name='Account number'),
        ),
        migrations.AlterField(
            model_name='bankwithdraw',
        ...
        migrations.AlterField(
            model_name='bankwithdraw',
            name='account_type',
            field=models.CharField(choices=[('corrente', 'Corrente'), (
                'poupanca', 'Poupança')], max_length=20, verbose_name='Account type'),
        ),
        migrations.AlterField(
            model_name='bankwithdraw',
            name='agency',
        ...
        migrations.AlterField(
            ...
            name='fee',
            field=models.DecimalField(decimal_places=8, default=Decimal(
                '0.00'), max_digits=20, verbose_name='Fee'),
        ),
        migrations.AlterField(
            model_name='bankwithdraw',
            name='reserved',
        ...
        migrations.AlterField(
            model_name='bankwithdraw',
            name='status',
            field=models.CharField(choices=[('requested', 'requested'), ('reversed', 'reversed'), (
                'paid', 'paid')], default='requested', max_length=20, verbose_name='Status'),
        ),
        migrations.AlterField(
            model_name='bankwithdraw',
            name='tx_id',
            field=models.CharField(
                blank=True, max_length=150, null=True, verbose_name='Transaction id'),
        ),
        migrations.AlterField(
            model_name='companies',
            name='document_1',
            field=models.CharField(
                blank=True, max_length=50, null=True, verbose_name='Document 1'),
        ),
        migrations.AlterField(
            model_name='companies',
            name='document_2',
            field=models.CharField(
                blank=True, max_length=50, null=True, verbose_name='Document 2'),
        ),
        migrations.AlterField(
            model_name='companies',
            name='name',
        ...
        migrations.AlterField(
            ...
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                    related_name='companies', to=settings.AUTH_USER_MODEL, verbose_name='User'),
        ),
        migrations.AlterField(
            model_name='cryptowithdraw',
            name='account',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                    related_name='crypto_withdraw', to='exchange_core.Accounts', verbose_name='Account'),
        ),
        migrations.AlterField(
            model_name='cryptowithdraw',
            name='address',
        ...
        migrations.AlterField(
            model_name='currencies',
            name='type',
            field=models.CharField(choices=[('checking', 'checking'), (
                'investment', 'investment')], default='checking', max_length=20, verbose_name='Type'),
        ),
        migrations.AlterField(
            model_name='currencies',
            name='withdraw_receive_hours',
            field=models.IntegerField(
                default=48, verbose_name='Withdraw receive hours'),
        ),
        migrations.AlterField(
            model_name='documents',
            name='file',
            field=models.ImageField(
                upload_to=exchange_core.models.get_file_path, verbose_name='File'),
        ),
        migrations.AlterField(
            model_name='documents',
            name='status',
            field=models.CharField(choices=[('pending', 'pending'), ('disapproved', 'disapproved'), (
                'approved', 'approved')], default='pending', max_length=20, verbose_name='Status'),
        ),
        migrations.AlterField(
            model_name='documents',
            name='type',
            field=models.CharField(choices=[('id_front', 'id_front'), ('id_back', 'id_back'), ('selfie', 'selfie'), (
                'contract', 'contract'), ('residence', 'residence')], max_length=20, verbose_name='Type'),
        ),
        migrations.AlterField(
            model_name='documents',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                    related_name='documents', to=settings.AUTH_USER_MODEL, verbose_name='User'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.UUIDField(
                blank=True, editable=False, null=True, verbose_name='Foreign key'),
        ),
        migrations.AlterField(
            model_name='statement',
            name='tx_id',
        ...
        migrations.AlterField(
            ...
            name='avatar',
            field=models.ImageField(
                blank=True, upload_to=exchange_core.models.get_file_path, verbose_name='Avatar'),
        ),
        migrations.AlterField(
            model_name='users',
            name='document_1',
            field=models.CharField(
                blank=True, max_length=50, null=True, unique=True, verbose_name='Document 1'),
        ),
        migrations.AlterField(
            model_name='users',
            name='document_2',
            field=models.CharField(
                blank=True, max_length=50, null=True, unique=True, verbose_name='Document 2'),
        ),
        migrations.AlterField(
            model_name='users',
            name='mobile_phone',
            field=models.CharField(
                blank=True, max_length=20, null=True, verbose_name='Mobile phone'),
        ),
        migrations.AlterField(
            model_name='users',
            name='profile',
            field=django.contrib.postgres.fields.jsonb.JSONField(
                blank=True, default={}, null=True, verbose_name='Profile data'),
        ),
        migrations.AlterField(
            model_name='users',
            name='type',
            field=models.CharField(choices=[('person', 'person'), ('company', 'company')],
                                   default='person', max_length=11, null=True, verbose_name='Type'),
        ),
    ]
